"""
Instagram Publisher: interacts with Meta Graph API to publish Feed posts, Stories, Reels, and Carousels.
"""
...
class InstagramPublisher(BasePublisher):
    """
    Publisher implementation for Instagram via Meta Graph API.
    """
    ...
    def __init__(
        ...
        self.api_version = api_version or settings.IG_GRAPH_API_VERSION
        self.base_url = f"https://graph.facebook.com/{self.api_version}"
        self.account_id = account_id or settings.IG_USER_ID
...
# Default singleton instance & backward-compatible alias
instagram_publisher = InstagramPublisher()
InstagramService = InstagramPublisher

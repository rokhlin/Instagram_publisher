"""
WhatsApp Communication Connector: interacts with the Node.js WhatsApp bot service
via REST API for outbound messaging, media sending, and connection status polling.
"""
